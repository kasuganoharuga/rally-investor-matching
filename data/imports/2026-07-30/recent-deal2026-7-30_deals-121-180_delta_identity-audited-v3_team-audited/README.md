# Incremental database import: recent-deal2026-7-30 rows 122-181

This is an Investor-deduplicated delta package for 60 funding transactions.

## Investor handling

- Existing database Investors: 46. Their master records are not re-exported.
- New Investor masters: 75. They are included once.
- Deal-Investor relations: 150. These supplement existing and new Investors.
