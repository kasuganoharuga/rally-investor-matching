# Incremental database import: recent-deal2026-7-30 batch 1

This is an Investor-deduplicated delta package for 60 funding transactions.

## Investor handling

- Existing database Investors: 52. Their master records are not re-exported.
- New Investor masters: 83. They are included once.
- Deal-Investor relations: 156. These supplement existing and new Investors.
- Removed duplicate same-deal alias relations: 1.
...
All 60 Investee profiles now include normalized primary and secondary sector, primary and secondary use case, customer type, business model, sales motion, technology depth, and AI relevance fields.
