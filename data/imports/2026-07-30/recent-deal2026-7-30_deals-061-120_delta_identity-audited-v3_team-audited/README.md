# Incremental database import: recent-deal2026-7-30 rows 62-121

This is an Investor-deduplicated delta package for 60 funding transactions.

## Investor handling

- Existing database Investors: 43. Their master records are not re-exported.
- New Investor masters: 71. They are included once.
- Deal-Investor relations: 143. These supplement existing and new Investors.
